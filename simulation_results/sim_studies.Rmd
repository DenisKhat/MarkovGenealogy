...
## Sampled State
sampled_events <- read.csv("simulation_results/sample_times_lim.csv")
### Stats
...
ggplot(data=sampled_events) +
  ...
  labs(
    title = "Sampled Events Beta Estimate Distribution (2.2)",
    y="Counts",
    x="Beta Estimate (Bins of width 0.05)",
    color="Statistic"
  ) +
...
ggplot(data=sampled_events) +
  ...
  labs(
    title = "Sampled Events Gamma Estimate Distribution (2.2)",
    y="Counts",
...
ggplot(heatmap_vals, aes(beta, gamma)) +
  ...
  geom_point(aes(x=0.7, y=0.3),color="palevioletred3") +
    ...
    labs(
      title=paste("Exact Times Likelihood (2.1)"),
      x=expression("Beta"),
      y=expression("Gamma"),
      fill="Log Likelihood")
