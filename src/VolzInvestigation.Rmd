...
Volz_SIR(beta=0.7,gamma=0.3, sample_times = coalescent_times)
...
```{r}
source("Volz.R")
experimental_A <- readRDS("../simulation_results/experimental_A.RDS")
...
ggplot(data=A_data) +
  ...
  geom_line(data=ODE_A, color="blue4",aes(x=time,y=I),linewidth=1) 
